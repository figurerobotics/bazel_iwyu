...
http_archive(
    name = "com_github_figurerobotics_bazel_iwyu",
...
load("@com_github_figurerobotics_bazel_iwyu//bazel:dependencies.bzl", "bazel_iwyu_dependencies")
...
```
build:iwyu --aspects @com_github_figurerobotics_bazel_iwyu//bazel/iwyu:iwyu.bzl%iwyu_aspect
...
```
build:iwyu --@com_github_figurerobotics_bazel_iwyu//:iwyu_mappings=//bazel/iwyu:my_mappings
```

If custom IWYU options should be used, change the line below:

```
build:iwyu --@com_github_figurerobotics_bazel_iwyu//:iwyu_opts=--verbose=3,--no_fwd_decls,--cxx17ns,--max_line_length=127
```
